...
import UpdateCalligraphyForm from "@/components/forms/updateForms/updateCharacterForm";
...
export default async function UpdateCalligraphyPage({ params }: { params: paramsType }) {
    ...
    return (
        <main className="p-4">
            ...
            <UpdateCalligraphyForm calligraphy={calligraphy} existingUnitsId={existingUnitsId} />
        </main>
    );
}