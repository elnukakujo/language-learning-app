...
@bp.route('/evaluate/translate', methods=['POST'])
def evaluate_translation():
    ...
    exercise = exercise_service.evaluate_translation(
    ...
    if exercise is not None:
        ...
        return jsonify({'error': 'exercise not found or translation evaluation failed'}), 404